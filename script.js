...
//       prompt() Function: This is a built-in JavaScript function that 
//       displays a dialog box with an optional message prompting the 
//       user to input some text. The function returns the text entered 
//       by the user as a string. If the user clicks "Cancel," it returns null.
//       The entered value is stored in the timeQuantum variable.
//      The script checks if timeQuantum is not null (meaning the user entered 
//        a value and clicked "OK").
